...
wget https://github.com/Noobproject/gestoweb/raw/main/gestorssh.zip > /dev/null 2>&1
...
sleep 1
cd || exit
wget https://github.com/Noobproject/gestoweb/raw/main/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
cd /bin || exit
wget https://github.com/Noobproject/gestoweb/raw/main/userteste.sh
wget https://github.com/Noobproject/gestoweb/raw/main/autobackup.sh
